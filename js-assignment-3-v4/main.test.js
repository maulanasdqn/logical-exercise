  ...
  describe("when parameter correction is empty", () => {
    it("should output", () => {
      ...
      expect(salesReport(data, correction)).toEqual({
        ...
        bestSalesman:
          "Penjualan terbanyak dilakukan oleh Adi dengan total penjualan dalam 1 bulan sebesar 200",
      });
    });
  });
  ...
  describe("when parameter correction is not empty and type is tambah", () => {
    it("should output", () => {
      ...
      expect(salesReport(data, correction)).toEqual({
        ...
        bestSalesman:
          "Penjualan terbanyak dilakukan oleh Udin dengan total penjualan dalam 1 bulan sebesar 200",
      });
    });
  });
  ...
  describe("when parameter correction is not empty and type is tambah and koreksi", () => {
    it("should output", () => {
      ...
      expect(salesReport(data, correction)).toEqual({
        ...
        bestSalesman:
          "Penjualan terbanyak dilakukan oleh Poltak dengan total penjualan dalam 1 bulan sebesar 150",
      });
    });
  });
